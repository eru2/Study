...
<body>
    ...
    <h3>2. 대소비교</h3>
     ...
     sThree과 "Hello"와 일치하는가? ${sThree == "hello"} 또는 ${sThree eq "hello"}

     <h4>4. 객체가 null인지 안니자, list가 비어있는지 비교</h4>
     pOne이 null입니까? ${pOne == null} 또는 ${pOne eq null} 또는 ${empty pOne} <br>
     pTwo이 null입니까? ${pTwo == null} 또는 ${pTwo eq null} 또는 ${empty pTwo} <br>

     pTwo이 null이 아닙니까? ${pTwo != null} 또는 ${pTwo ne null} 또는 ${not empty pTwo} <br>
     <br>
     ...
     <h4>5. 논리연산자</h4>
      ...
      false || ture : ${false || true} 또는 ${false or true} <br><br>

      big이 small보다 크고 aOne이 비어있는가? 
      ${big > small && empty aOne},
      ${big gt small and empty aOne} <br><br>
</body>
</html>