...
<body>
    ...
    <p>
        EL을 이용하여 getter를 통해 가져올 필요 없이 EL구문내의 키값만 제사하면 바로 접근 가능 <br>
        EL은 JSP의 scope 구분하지않고 자동으로 모든 scope의 키 값을 검색하여 존재하는 경우 그 값을 가져옴
    </p>
    ...
    <p>EL은 공유범위가 가장 작은 scope부터 해당 키값을 검색함(pag -> request -> session -> application)</p>
    test값 : ${test}
