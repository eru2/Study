            ...
            <table>
				...
				<script>
					...
					for(let input of inputArr){
						if(interest.includes(input.value)){ //interest에 input.value의 값이 포함되어있다면
							input.checked = true;
						}
					}
				</script>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="${pageContext.request.contextPath}/updatePwd.me" method="post">
            ...
            <br>
            <button id="edit-pwd-btn" type="submit" class="btn btn-success">비밀번호 변경</button>
        </form>

        <script>
            document.getElementById('edit-pwd-btn').onclick(){
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <b align="center">탈퇴 후 복구가 불가능합니다.
    	정말 탈퇴하시겠습니까?</b>
                <table align="center">
                    <tr>
                        <td>비밀번호 : </td>
