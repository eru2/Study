...
<body onload="init(${board.boardNo})">
	...
	<div class="outer">
        ...
        <div align="center">
            <a class="btn btn-sm btn-light" href="${pageContext.request.contextPath}/list.bo?cpage=1">목록가기</a>
            <c:if test="${loginUser != null && loginUser.userId == board.userId}">
	            <a class="btn btn-sm btn-light" href="${pageContext.request.contextPath}/updateForm.bo?bno=${board.boardNo}">수정하기</a>
	            <a class="btn btn-sm btn-light">삭제하기</a>
            </c:if>
        </div>
