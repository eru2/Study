	...
	<div class="outer">
		...
		<form action="${pageContext.request.contextPath}/update.me" method="post" id="update-form">
			...
			<script>
				...
				const input = document.querySelectorAll("input[name=gender]");
					if(interest.includes(input.value)){ // gender에 input.value의 값이 포함되어 있다면
						input.checked = true;
					}
			</script>
			...
			<div align="center">
				...
				<button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#update-pwd-modal">비밀번호 변경</button>
