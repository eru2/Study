 ...
 * 3) PascalCase -> c#및 ms계열의 언어에서 많이 사용하는 방식 매 단어 시갖은 무조건 대문자이다.
 */
...
console.log(num1 == "55"); //타입을 제거하고 비교 즉 숫자타입인 55와 문자타입 "55"가 상관없이 동일하다고 나옴
console.log(num1 === "55");
...
let num2;
console.log(num2);
console.log(typeof num2); //타입이 undefined (?) 그러면 num2에 값이 들어가면 타입이 변경(?)
//그러면 let num1 = 10;선언 후 num1 = "안녕하세요" 선언 가능(?)

/**
 * null
 * 
 * undefined과 동일하게 값이 없음을 표시한다.
 * 다만 js에서는 개발자가 직접 명식적으로 없는 값을 초기화할때 사용
 */
