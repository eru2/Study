...
public class properiesRun {
	
	public static void main(String[] args) {
		//Properties
		
		/*
		 * Properties 특징 : Map 계열 컬렉션 (key-value형식으로 저장함)
		...
		try {
			prop.store(new FileOutputStream("resources/driver.propertiees"), "Properties Test");
...
*/
	try {
		...
		System.out.println(prop.getProperty("deleteMeber"));
