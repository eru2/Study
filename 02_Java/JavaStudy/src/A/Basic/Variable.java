...
public class Variable {
	...
	public static void main(String[] args) {
		...
		//실수형 중 기본은 double 
		float num2 = 3.141234235236237238f;
		System.out.println(num2);
		System.out.printf("%.6f", num2);
		
		
		//=======================원시타입==============================
		//원시타입 : 가장 기본적인 데이터 타입 값 자체를 저장하며 추가적인 속성은 없다
		//문자 하나는 '' 문자열은 "" 문자열은 클래스로 만들기 때문에 자료형 첫번째가 대문자
		
		/*
		 * 정수 자료형
		 * byte(1), short(2), int(4), long(8)
		 * 모두 정수를 저장하는 자료형, 각 자료형 마다 표현할 수 있는 수의 범위가 다르다.
		 * 
		 * 정수 리터럴은 기본적으로 int타입으로 간주된다.
		 * 그러나 변수의 타입에 따라서 적절하게 변환되거나 명시적으로 변환해주어야 한다.
		 * byte, short는 범이내에 있을 경우 자동으로 변환된다.
		 * 		 
		 */
		...
		String str3 = null; //String은 참조변수이기 때문에 기본값이 null이다.
		...
		/*
		 * 이스케이프 시퀀스
		 * 문자열내에서 탭, 백슬러시, 작은따음표 등을 코드로 사용하기 위한 방식
		 * 
		 * 탭문자 \t
		 * 백슬레시 \\
		 * 작은 따음표 \'
		...
		final int MY_AGE;
		MY_AGE = 90;
//		MY_AGE = 20; 값을 초기화하면 더이상 변경할 수 없다.
