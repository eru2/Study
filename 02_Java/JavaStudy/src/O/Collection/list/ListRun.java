...
public class ListRun {
	...
	/*
	 * 컬랙션이란
	 * 자료구조 개념이 내장되어있는 클래스로 자바엣 제공하는 "자료구조"를 담당하는 "프레임워크"이다.
	 * 
	...
	public static void main(String[] args) {
		...
		//지정된 크기보다 더 많이 넣어도 에러가 발생하지 않는다. -> 장점1. 크기제약 x
		...
		// 3. remove(int index) : 해당 인덱스의 위치의 데이터를 삭제시켜주는 메서드
		list.remove(1);
		System.out.println(list);
		...
		// 9. isEmpty() :boolean -> 컬렉션이 비었는지 확인하는 메서드
