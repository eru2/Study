...
public class Run {
	 ...
	 * 
	 * 오버라이딩 전 : Object 클래스이 toString() 실행 -> 클래스명 + @ + 객체의 주소를 암호화한 16진수 값
	 * 오버라이딩 후 : Man 클래스(자식클래스)의 toString()을 실행
	 * 
	 *  *오버라이딩
	 *  - 자식클래스가 상속받고잇는 부모 클래스의 메서드를 재정의하는 것
