	...
	*/
	...
	public static void main(String[] args) {
		...
		if(num1 < 10 && num1 > 0 && num2 < 10 && num2 > 0) {
			x = num1 * num2;
			if(x<10){
				System.out.println("두 수의 곱은" + x + "로 한자리 수입니다.");
			}
			else if(x>=10 && x < 100) {
				System.out.println("두 수의 곱은 " + x + "으로 두자리 수이니다.");
			}
		}
		if(num1 < 10 && num1 > 0 && num2 < 10 && num2 > 0) {
			x = num1 * num2;
			if(x>10){
				System.out.println("두 수의 곱은" + x + "로 두자리 수입니다.");
			}
			else {
				System.out.println("두 수의 곱은 " + x + "으로 한자리 수이니다.");
			}
		}
	}
	*/
...
/*
	public static void main(String[] args) {
		...
		System.out.println("국어 : " + len);
		System.out.println("수학 : " + math);
		System.out.println("영어 : " + eng);
		
		if (len >= 40 && math >= 40 && eng >= 40 && evg >= 60) {
