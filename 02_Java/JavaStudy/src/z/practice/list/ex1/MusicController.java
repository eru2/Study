...
//		Music[] m = new Music[list.size()];
//		for(int i = 0 ; i < list.size(); i++) {
//			m[i] = (Music)list.get(i);
//			for(Music ml : m) {
//				if(ml.getTitle().equals(title)) {
//					return ml;
//				}else
//					return null;
//			}
...
//			for (Music ml : m) {
//				if (ml.getTitle().equals(title)) {
//					list.set(i, new Music(title, ml.getArtist()));
//					return m[i];
//				} else
//					return null;
//			
...
//		return null;
	...
	public int ascTitle() {
		//Collections.sort : 컬렉션에서 정렬기능을 제고하는 메서드(static)
