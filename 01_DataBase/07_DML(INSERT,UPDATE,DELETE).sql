/*
    ...
    DML(MANITPULATION 데이터 조작어) : INSERT, UPDATE, DELETE
...
/*
    ...
    부조하게 값을 제시할 겨우, 값을 더 많이 제시한 경우 -> 에러 발생
...
INSERT INTO EMPLOYEE VALUES (500, '이소금', '880914-1234567', 'KKKH_HH@KH.OR.KR', '01011112222', 'D7', 'J5', 4000000, 0.2, 200, SYSDATE, NULL, 'N');

/*

    2) INSERT INTO 테이블명(컬럼, 컬럼, 컬럼, 컬럼....) VALUES(값, 값, 값, 값.....)
...
/*
    ...
    (표현식)
    INSERT ALL
    INTO 테이블명1 VALUES(컬럼,컬럼,컬럼,컬럼...)
    INTO 테이블명2 VALUES(컬럼,컬럼,컬럼,컬럼....)
    서브쿼리;
